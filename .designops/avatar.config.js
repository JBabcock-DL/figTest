// CONFIG block generated by scripts/build-config-block.mjs for "avatar"
...
const CONFIG = {
  ...
  usageDo:   [
    "Use avatar for its intended semantic purpose.",
    "Keep labels or content concise and actionable.",
    "Follow established spacing and sizing patterns.",
  ],
  usageDont: [
    "Don\'t repurpose avatar for unrelated interactions.",
