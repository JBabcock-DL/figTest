...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-[var(--space-sm)] py-[var(--space-xs)] text-label-sm transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-focus-ring)] focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent text-[var(--color-on-primary)] state-filled-primary",
        secondary:
          "border-transparent text-[var(--color-on-secondary)] state-filled-secondary",
        destructive:
          "border-transparent text-[var(--color-on-danger)] state-filled-error",
