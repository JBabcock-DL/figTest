  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-ring border-[var(--color-field)] shadow-xs has-focus:ring-[var(--color-focus-ring)]/50 has-focus:ring-[3px] relative rounded-[var(--radius-md)] border",
