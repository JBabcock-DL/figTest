...
export function PlaceholderPage({ title }: { title: string }) {
  return (
    <main className="flex min-h-[70vh] w-full flex-col items-center justify-center gap-[var(--space-md)] bg-[var(--color-background-bright)] px-[var(--space-4xl)] pt-[160px] pb-[var(--space-4xl)] text-[var(--color-content)]">
